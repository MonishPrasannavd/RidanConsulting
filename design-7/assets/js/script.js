(function ($) {
  ...
  //Main Slider Five 
  if ($(".main-slider-five__carousel").length) {
    $(".main-slider-five__carousel").owlCarousel({
      loop: true,
      animateOut: "fadeOut",
      animateIn: "fadeIn",
      margin: 0,
  ...
  if ($(".portfolio-three__carousel").length) {
    $(".portfolio-three__carousel").owlCarousel({
      loop: true,
      margin: 10,
      nav: false,
      dots: false,
  ...
  if ($(".portfolio-four__carousel").length) {
    $(".portfolio-four__carousel").owlCarousel({
      loop: true,
      margin: 10,
      nav: false,
      dots: false,
  ...
  //News Carousel Page Style
  if ($(".news-carousel-style").length) {
    $(".news-carousel-style").owlCarousel({
      loop: true,
      margin: 30,
      nav: false,
      dots: true,
